...
export const metadata: Metadata = {
  title: '캐릭터챗 에이전트 - B2B AI Agent Platform',
  description:
    '자연스러운 대화와 상호작용을 제공하는 캐릭터챗 에이전트의 기능과 활용 사례를 소개합니다',
}

export default function CharacterChatAgentPage() {
  return (
        ...
        <Container>
          <div className="py-12">
            ...
            <div className="mb-16 text-center">
              <h1 className="text-5xl font-bold">캐릭터챗 에이전트</h1>
              <p className="text-muted-foreground mx-auto mt-6 max-w-2xl text-xl">
                대화형 인터랙션을 담당하는 전문 AI 에이전트
              </p>
            </div>
            ...
            <div className="prose prose-lg dark:prose-invert mx-auto max-w-4xl">
              <section className="mb-12">
                ...
                <p className="text-muted-foreground mt-4 text-lg">
                  자연스러운 대화와 상호작용을 제공하는 전문 에이전트입니다.
                </p>
